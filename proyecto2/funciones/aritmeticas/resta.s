...
restaCMP:
    ...
    restaLoop:
        ...
        CBZ w2, guardarRestaVal      // Si w2 es 0, saltar a guardarRestaVal

        CMP w2, w3              // Comparamos w2 con w3
        BNE restaError         // Si w2 es diferente a w3, saltar a restaError

        B restaLoop          // Si no se cumple la condicion, repetir el ciclo
    ...
    guardarRestaVal:
        ...
        guardarRestaValLoop:
            ...
            restaFirtCol:
                ...
                B guardarRestaValLoop
            
            restaConfNeg:

                CBNZ x23, restaError    // Si ya se encontro una columna entonces no puede haber un valor negativo
    ...
    restaConf:
        ...
        CBZ x24, restaError     // si no encontro ningun valor (ya sea fila o valor inmediato) entonces se supone que columna tampoco y tira error
        ...
        restaConfLoop:
            ...
            CBZ w2, guardarRestaSecVal    // Si el byte del comando del usuario es 0 entonces se sale del loop

            CMP w2, w3          // Se compara si los bytes son iguales
            BNE restaError      // Si no son iguales, se pasa con el siguiente procedimiento
    ...
    guardarRestaSecVal:
        ...
        resta_second_Loop:
            ...
            CMP w2, 65          // Se compara si el byte es una A
            BGE resta_second_column

            CMP w2, 48          // Se compara si el byte es un 0
            BGE resta_second_value
            ...
            resta_conf_neg2:
                ...
                CBNZ x25, restaError    // Si ya se encontro una columna entonces no puede haber un valor negativo
    ...
    Resta_Ejecutar:
        ...
        CBZ x23, val_inmediato_res    // Si no se encontro una columna entonces se asume que es un valor inmediato
        ...
        resta_operador2:
            ...
            CBZ x25, val_inmediato_res2    // Si no se encontro una columna entonces se asume que es un valor inmediato
        ...
        resta_End:
            ...
            SUB x21, x18, x21       // Se suma los valores de las celdas o inmediatos
